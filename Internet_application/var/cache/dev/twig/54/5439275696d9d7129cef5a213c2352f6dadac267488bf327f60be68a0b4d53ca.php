...
class __TwigTemplate_287437c566ac606c94b7cf705906d6db4e0947e0ae1d2af6f047b4d35fda5cc6 extends Twig_Template
{
    ...
    <a class=\"";
            ...
            echo "\" title=\"";
            echo twig_escape_filter($this->env, ((twig_test_empty((($this->getAttribute($context["action"], "title", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["action"], "title", []), "")) : ("")))) ? ("") : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans($this->getAttribute($context["action"], "title", []), ($context["trans_parameters"] ?? $this->getContext($context, "trans_parameters")), ($context["translation_domain"] ?? $this->getContext($context, "translation_domain"))))), "html", null, true);
            echo "\" href=\"";
...
{% endfor %}
", "@EasyAdmin/default/includes/_actions.html.twig", "C:\\wamp64\\www\\rfid\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\default\\includes\\_actions.html.twig");
    }
}
