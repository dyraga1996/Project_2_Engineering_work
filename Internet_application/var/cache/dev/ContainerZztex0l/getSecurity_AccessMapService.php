...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/access'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/test_connection'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/rfid/temp'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/logs/synchronize'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
